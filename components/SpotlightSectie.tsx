...
export default function SpotlightSectie() {
  return (
    <section className="bg-donker px-[5%] py-20">
      <div className="max-w-[1200px] mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_1fr_0.85fr] gap-10 items-stretch">
          <div>
            <div className="inline-block bg-oranje/10 border border-oranje/25 text-oranje text-[11px] font-semibold px-2.5 py-1 rounded-lg uppercase mb-4">
